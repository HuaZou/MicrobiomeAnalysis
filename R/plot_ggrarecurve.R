# https://github.com/YuLab-SMU/MicrobiotaProcess/blob/master/R/plot-ggrarecurve.R

#' @title Rarefaction alpha index
#'
#' @author Created by Shuangbin Xu; modified by Hua Zou
#'
...
#' @rdname ggrarecurve
#' @export
ggrarecurve.data.frame <- function(obj,
                                   sampleda,
                                   factorLevels,
                                   chunks=100,
                                   ...){
...
#' @title generate the result of rare curve.
#'
#' @description
...
#'     data(caporaso)
#'     set.seed(123)
#'     res <- get_rarecurve(caporaso, chunks=400)
